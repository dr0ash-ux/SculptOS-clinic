...
function Login({ dark, setDark, notice }: { dark: boolean; setDark: (value: boolean) => void; notice: string }) {
  ...
  return <div className={dark ? 'login dark' : 'login'}>
    <section className="login-visual"><img className="anatomy-hero" src="/sphenoid-hero.jpg" alt="Human skull with highlighted sphenoid bone" /><div className="visual-overlay"><span className="eyebrow">SCULPTOS CLINIC</span><h1>Your practice,<br /><em>made structured.</em></h1><p>Appointments, patient journeys and clinical context—kept organised in one secure workspace.</p></div></section>
